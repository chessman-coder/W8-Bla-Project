...
class HomeContent extends StatelessWidget {
  ...
  void _onRidePrefSelected(
    ...
    await viewModel.selectPref(selectedPreference);
          ...
          child: Column(
            ...
            children: [
              ...
              BlaRidePreferencePicker(
                initRidePreference: viewModel.selectedPref,
  ...
  Widget _buildHistory(BuildContext context) {
    ...
    List<RidePreference> history = viewModel.prefHistory.reversed.toList();
    return SizedBox(
